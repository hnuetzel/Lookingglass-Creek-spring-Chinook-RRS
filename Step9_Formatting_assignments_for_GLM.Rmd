...
individ_sex_to_update <- bind_rows(par_assign_M_update, par_assign_F_update)

par_assign_update <- left_join(par_assign, individ_sex_to_update, by = "CRITFC_ID") %>%
